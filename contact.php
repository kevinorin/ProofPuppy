...
<script>
  ...
  ga('create', 'UA-49852234-1', 'proofpuppy.com');
  ga('send', 'pageview');
  ...
  <head>
    ...
    <meta name="description" content="ProofPuppy is a fast, cheap and efficient proofing service for live websites and documents.">
...
<div id="contact">
  <div class="bg-contact grey">
    <div class="container-contact container">
      <div class="row">
        <div class="col-sm-12">
          <h1 class="header-title wow fadeInLeft">CONTACT US</h1>
          <h2 class="subtitle wow fadeInRight">Feel free to contact us anytime.</h2>
          <hr class="hr-contact">
        </div>
      </div>
      <!-- GOOGLE-MAPS 
      <div class="row">
        <div class="col-map col-sm-12 wow fadeInUp ">
          <div  id="map-canvas">
          </div>
        </div>
      </div> -->
          ...
          <div class="row-info row">
            <div class="wow fadeInUp">
              ...
              <div class="col-info col-sm-12">
                ...
                <P class="p-contact">We'd love to here from you. Drop us a line if you have any questions. Or just let us know what you're working on so that we can find ways to help serve you better.
                </P>
              </div>
...
olark.identify('6763-776-10-8872');/*]]>*/</script><noscript><a href="https://www.olark.com/site/6763-776-10-8872/contact" title="Contact us" target="_blank">Questions? Feedback?</a> powered by <a href="http://www.olark.com?welcome" title="Olark live chat software">Olark live chat software</a></noscript>
<!-- end olark code -->
  </body>
</html>
